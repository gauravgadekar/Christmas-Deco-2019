...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class ManipulationSystem : MonoBehaviour
    {
        ...
        private void Start()
        {
            UIGrp = GameObject.FindGameObjectsWithTag("UIGrp");
        }
        ...
        void UiToggle()
        {
            if (uiToggle == false)
            {
                ...
                foreach (GameObject cui in UIGrp)
                {
                    cui.SetActive(false);
                }
        ...
        public void uiCheck(bool uicheck)
        {
            uiToggle = uicheck;
        }
        ...
        public void SelectDestroy()
        {
            if ((Input.touchCount > 0) && (Input.GetTouch(0).phase == TouchPhase.Began))
            {
                ...
                if (Physics.Raycast(raycast, out raycastHit))
                {
                    ...
                    if (raycastHit.collider.gameObject.tag == "prefabGrp")
                    {
